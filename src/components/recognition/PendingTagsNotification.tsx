  ...
  return (
    <div className="rounded-xl border border-[#c88a65]/30 bg-[#c88a65]/10 p-4 mb-6 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-white">{t('recognition.pendingTitle')}</p>
          <p className="text-xs text-white/70">{t('recognition.pendingCopy', { count: pendingCount })}</p>
        </div>
      </div>
      <Link 
        to="/settings"
